...
public class JwtService {
    ...
    private final String 비밀번호 = "12345678909876543212121212343132"; // 32글자 이상
...
//                .claim("key",value) 토큰에 저장할 자료를 key 와 value 대입한다
                ...
                .setExpiration(new Date(System.currentTimeMillis()+1000 * 20 )) // 토큰 유지/유효시간 , 초단위
//                .signWith(비밀키 , 암호화알고리즘)
    ...
    public String 값추출(String 토큰){
        try {
            ...
            return (String) claims.get("data"); // 저장된 값은 무조건 object 타입 이다
        }catch (Exception e){
